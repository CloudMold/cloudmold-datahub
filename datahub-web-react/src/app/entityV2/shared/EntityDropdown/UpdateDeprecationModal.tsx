import { Button, DatePicker, Loader, Modal, TextArea, toast } from '@components';
...
export const UpdateDeprecationModal = ({
    ...
    // assembled from what the picker already knows.
    const replacementEntity: Entity | null = useMemo(() => {
        if (!replacementUrn) return null;
        if (isDeprecatingFields) return { urn: replacementUrn, type: EntityType.SchemaField };
        return replacementData?.entities?.[0] ?? null;
    }, [isDeprecatingFields, replacementUrn, replacementData]);
            ...
            <FieldGroup>
                ...
                {isReplacementModalVisible && isDeprecatingFields && (
                    <SelectColumnReplacementModal
                        ...
                        initialFieldPath={
                            replacementColumnUrn ? getFieldPathFromSchemaFieldUrn(replacementColumnUrn) : undefined
                        }
